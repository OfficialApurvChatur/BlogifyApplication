              ...
              return (
                <React.Fragment key={index}>
                  <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                    <div className="bg-[#4A171E] dark:bg-[#E2B143] text-[#E2B143] dark:text-[#4A171E] bg-opacity-60 px-4 py-6 rounded-lg">
                      {
                        each.title === "Frontend Application Deployed" ? (
                          <div className="w-12 h-12 mb-3 inline-flex items-center justify-center rounded-full bg-[#E2B143] dark:bg-[#4A171E] text-[#4A171E] dark:text-[#E2B143] flex-shrink-0">
