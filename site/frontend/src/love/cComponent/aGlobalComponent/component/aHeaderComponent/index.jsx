...
function HeaderComponent({ Redux, LogoutAPICall }) {
  return (
    ...
    <React.Fragment>
      <header className="sticky top-0 z-50 w-full backdrop-blur supports-[backdrop-filter]:bg-[#E2B143]/60 dark:supports-[backdrop-filter]:bg-[#4A171E]/60 text-[#4A171E] dark:text-[#E2B143]">
