    ...
    <>
      <Card 
        className={`
          ...
          bg-[#E2B143] dark:bg-[#4A171E]
          border-[#4A171E] dark:border-[#E2B143]
          text-[#4A171E] dark:text-[#E2B143]`}
      >
        <CardHeader className="flex flex-row items-center justify-between py-2 border-b border-[#4A171E] dark:border-[#E2B143]">
        ...
        <CardFooter className="py-2 border-y border-[#4A171E] dark:border-[#E2B143] bottom-0">
          <form className="flex w-full items-center space-x-2">
            <Input
              id="message"
              placeholder="Type your message..."
              className="flex-1 border-[#4A171E] dark:border-[#E2B143]"
              autoComplete="off"
              value={input}
